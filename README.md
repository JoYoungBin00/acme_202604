...
gantt
    ...
    section 기획
    기존 사이트 분석 및 목표 정의           :a1, 2026-04-28, 1d
    기획 발표 및 역할 분담                 :a2, 2026-04-29, 1d
    스토리보드 및 CTA 흐름 설계            :a3, 2026-04-30, 1d

    section 디자인
    레이아웃 및 스타일가이드 기획          :b1, 2026-05-03, 2d

    section UX
    다크모드 및 버튼 피드백 설계           :c1, 2026-05-05, 2d

    section 개발
    시맨틱 마크업 및 스타일 구현           :d1, 2026-05-07, 2d

    section 반응형
    반응형 UI 구현                         :e1, 2026-05-09, 1d

    section 최종 개발
    컬러 검수 및 배포                     :f1, 2026-05-10, 1d
```
